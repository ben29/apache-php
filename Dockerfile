...
ENV DEPEND="apr-dev apr-util-dev libc-dev pcre-dev nghttp2-dev make ca-certificates gcc perl libxml2-dev curl-dev libpng-dev oniguruma-dev libzip-dev openssl"
